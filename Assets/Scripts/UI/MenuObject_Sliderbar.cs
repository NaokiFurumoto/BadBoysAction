...
public class MenuObject_Sliderbar : MonoBehaviour
{
	...
	public Vector2 CurosorPosition => curosorPosition;
	...
	public void Init()
	{
		...
		//ボタンイベントの設定
		MaxButton.onClick.AddListener(() => SetPosition(new Vector2(1.0f, 0.0f)));
		MinButton.onClick.AddListener(() => SetPosition(new Vector2(0.0f, 0.0f)));
	}
