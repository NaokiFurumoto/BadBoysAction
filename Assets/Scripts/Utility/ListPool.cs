...
#pragma warning disable CA1000
    /// <summary>Clear済みのList<T>をPoolから貸す。足りなければnewする。</summary>
    ...
    /// <summary>List<T>をPoolに返却する。</summary>
...
public static class ListPool
{
    ...
    /// <summary>ListPoolで借りたListを使い複製する</summary>
    ...
    /// <summary>ListPoolで借りたListにする</summary>
